...
class CrudOperations {
  ...
  static Future<bool> editExpense(int id, String expenseTitle, num amount, String date) async {
  ...
  static Future<bool> addExpense(int id, String expenseTitle, num amount, String date) async {
    final response = await http
        .post(
